...
am_minerd_OBJECTS = minerd-cpu-miner.$(OBJEXT) minerd-util.$(OBJEXT) \
	...
	minerd-jh.$(OBJEXT) minerd-primio.$(OBJEXT)
...
LIBCURL = -lcurldll
LIBCURL_CPPFLAGS = -DCURL_STATICLIB -I/mingw/include
LIBOBJS = 
LIBS = -lcrypto -lssl 
LTLIBOBJS = 
MAINT = #
...
WS2_LIBS = -lws2_32
_libcurl_config = 
abs_builddir = /c/cpuminer-master
abs_srcdir = /c/cpuminer-master
abs_top_builddir = /c/cpuminer-master
abs_top_srcdir = /c/cpuminer-master
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /c/cpuminer-master/install-sh
...
minerd_CPPFLAGS = -DCURL_STATICLIB -I/mingw/include
...
include ./$(DEPDIR)/minerd-primio.Po
...
minerd-primio.o: primio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-primio.o -MD -MP -MF $(DEPDIR)/minerd-primio.Tpo -c -o minerd-primio.o `test -f 'primio.c' || echo '$(srcdir)/'`primio.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/minerd-primio.Tpo $(DEPDIR)/minerd-primio.Po
#	$(AM_V_CC)source='primio.c' object='minerd-primio.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-primio.o `test -f 'primio.c' || echo '$(srcdir)/'`primio.c

minerd-primio.obj: primio.c
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-primio.obj -MD -MP -MF $(DEPDIR)/minerd-primio.Tpo -c -o minerd-primio.obj `if test -f 'primio.c'; then $(CYGPATH_W) 'primio.c'; else $(CYGPATH_W) '$(srcdir)/primio.c'; fi`
	$(AM_V_at)$(am__mv) $(DEPDIR)/minerd-primio.Tpo $(DEPDIR)/minerd-primio.Po
#	$(AM_V_CC)source='primio.c' object='minerd-primio.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-primio.obj `if test -f 'primio.c'; then $(CYGPATH_W) 'primio.c'; else $(CYGPATH_W) '$(srcdir)/primio.c'; fi`
